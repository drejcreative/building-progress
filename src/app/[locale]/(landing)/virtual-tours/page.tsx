...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "VirtualTours" });
  ...
  return {
    ...
    alternates: {
      canonical: `https://proinvest.rs/${locale}/virtual-tours`,
      languages: {
        en: "https://proinvest.rs/en/virtual-tours",
        sr: "https://proinvest.rs/rs/virtual-tours",
        "x-default": "https://proinvest.rs/en/virtual-tours",
      },
    },
    openGraph: {
      type: "website",
      locale: locale === "rs" ? "sr_RS" : "en_US",
      url: `https://proinvest.rs/${locale}/virtual-tours`,
      siteName: "ProInvest",
      title,
      description,
      images: [
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">{t("types.subtitle")}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                {t("types.threeSixty.title")}
              </h3>
              <p className="text-gray-600 mb-6">
                {t("types.threeSixty.description")}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.threeSixty.interactive")}
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.threeSixty.mobile")}
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.threeSixty.embed")}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                {t("types.videoTours.title")}
              </h3>
              <p className="text-gray-600 mb-6">
                {t("types.videoTours.description")}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.videoTours.narrated")}
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.videoTours.hd")}
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.videoTours.shareable")}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                {t("types.floorPlans.title")}
              </h3>
              <p className="text-gray-600 mb-6">
                {t("types.floorPlans.description")}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.floorPlans.clickable")}
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.floorPlans.measurements")}
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                  {t("types.floorPlans.furniture")}
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2">
                  {t("benefits.stat1.value")}
                </div>
                <div className="text-purple-100">
                  {t("benefits.stat1.label")}
                </div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2">
                  {t("benefits.stat2.value")}
                </div>
                <div className="text-purple-100">
                  {t("benefits.stat2.label")}
                </div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2">
                  {t("benefits.stat3.value")}
                </div>
                <div className="text-purple-100">
                  {t("benefits.stat3.label")}
                </div>
              </div>
            </div>
